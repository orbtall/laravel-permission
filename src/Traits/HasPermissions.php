...
namespace Orbtall\Permission\Traits;

use Illuminate\Database\Eloquent\Builder;
use Illuminate\Database\Eloquent\Relations\BelongsToMany;
use Illuminate\Support\Arr;
use Illuminate\Support\Collection;
use Orbtall\Permission\Contracts\Permission;
use Orbtall\Permission\Contracts\Role;
use Orbtall\Permission\Exceptions\GuardDoesNotMatch;
use Orbtall\Permission\Exceptions\PermissionDoesNotExist;
use Orbtall\Permission\Exceptions\WildcardPermissionInvalidArgument;
use Orbtall\Permission\Guard;
use Orbtall\Permission\PermissionRegistrar;
use Orbtall\Permission\WildcardPermission;
...
trait HasPermissions
{
     ...
     * @param  string|int|array|\Orbtall\Permission\Contracts\Permission|\Illuminate\Support\Collection  $permissions
     ...
     * @return array
     *
     * @throws \Orbtall\Permission\Exceptions\PermissionDoesNotExist
     */
     ...
     * Find a permission.
     *
     * @param  string|int|\Orbtall\Permission\Contracts\Permission  $permission
     * @return \Orbtall\Permission\Contracts\Permission
     *
     ...
     *
     * @param  \Orbtall\Permission\Contracts\Permission  $permission
     * @return bool
     */
     ...
     *
     * @param  \Orbtall\Permission\Contracts\Permission|\Orbtall\Permission\Contracts\Permission[]|string|string[]  $permission
     * @return $this
     */
    ...
    /**
     * @param  string|int|array|\Orbtall\Permission\Contracts\Permission|\Illuminate\Support\Collection  $permissions
     * @return \Orbtall\Permission\Contracts\Permission|\Orbtall\Permission\Contracts\Permission[]|\Illuminate\Support\Collection
     */
    ...
    /**
     * @param  \Orbtall\Permission\Contracts\Permission|\Orbtall\Permission\Contracts\Role  $roleOrPermission
     *
     * @throws \Orbtall\Permission\Exceptions\GuardDoesNotMatch
     */
