...
use Orbtall\Permission\Contracts\Permission as PermissionContract;
use Orbtall\Permission\Contracts\Role as RoleContract;
...
class PermissionServiceProvider extends ServiceProvider
{
    ...
    protected function registerBladeExtensions($bladeCompiler)
    {
        $bladeCompiler->directive('role', function ($arguments) {
            return "<?php if(\\Orbtall\\Permission\\PermissionServiceProvider::bladeMethodWrapper('hasRole', {$arguments})): ?>";
        });
        $bladeCompiler->directive('elserole', function ($arguments) {
            return "<?php elseif(\\Orbtall\\Permission\\PermissionServiceProvider::bladeMethodWrapper('hasRole', {$arguments})): ?>";
        });
        ...
        $bladeCompiler->directive('hasanyrole', function ($arguments) {
            return "<?php if(\\Orbtall\\Permission\\PermissionServiceProvider::bladeMethodWrapper('hasAnyRole', {$arguments})): ?>";
        });
        ...
        $bladeCompiler->directive('hasallroles', function ($arguments) {
            return "<?php if(\\Orbtall\\Permission\\PermissionServiceProvider::bladeMethodWrapper('hasAllRoles', {$arguments})): ?>";
        });
        ...
        $bladeCompiler->directive('hasexactroles', function ($arguments) {
            return "<?php if(\\Orbtall\\Permission\\PermissionServiceProvider::bladeMethodWrapper('hasExactRoles', {$arguments})): ?>";
        });
